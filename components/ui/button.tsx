...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase traking-wide",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-[#51cf66] text-primary-foreground border-[#2f9e44] border-b-4 active:border-b-0 hover:bg-[#51cf66]/90",
        secondaryOutline: "bg-white text-[#51cf66] hover:bg-slate-100",
        danger:
